...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        [Tooltip("Time it takes to interpolate camera position 99% of the way to the floorTargets."), Range(0.001f, 1f)]
        ...
        [Tooltip("Time it takes to interpolate camera rotation 99% of the way to the floorTargets."), Range(0.001f, 1f)]
        ...
        void Update()
        {
            ...
            // Calculate the lerp amount, such that we get 99% of the way to our floorTargets in the specified time
